...
namespace EventHotelBroker.Migrations
{
    ...
    [Migration("20260918120000_AddHotelCategoryTableAndColumn")]
    partial class AddHotelCategoryTableAndColumn
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EventHotelBroker.Models.HotelCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EventHotelBroker.Models.Review", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EventHotelBroker.Models.AuditLog", b =>
                {
                    b.HasOne("EventHotelBroker.Models.Users", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("EventHotelBroker.Models.EventEquipment", b =>
                {
                    b.HasOne("EventHotelBroker.Models.Users", "Provider")
                        .WithMany()
            ...
            modelBuilder.Entity("EventHotelBroker.Models.Hotel", b =>
                {
                    b.HasOne("EventHotelBroker.Models.HotelCategory", "HotelCategory")
                        .WithMany("Hotels")
                        .HasForeignKey("HotelCategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EventHotelBroker.Models.Users", "Owner")
                        .WithMany("Hotels")
            ...
            modelBuilder.Entity("EventHotelBroker.Models.Message", b =>
                {
                    ...
                    b.HasOne("EventHotelBroker.Models.Users", "Receiver")
                        .WithMany("ReceivedMessages")
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("EventHotelBroker.Models.Users", "Sender")
