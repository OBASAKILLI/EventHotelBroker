        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Category = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    PricePerUnit = table.Column<decimal>(type: "decimal(12,2)", precision: 12, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    PackageType = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    TotalPrice = table.Column<decimal>(type: "decimal(12,2)", precision: 12, scale: 2, nullable: false),
                    DiscountedPrice = table.Column<decimal>(type: "decimal(12,2)", precision: 12, scale: 2, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventEquipmentImages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EventEquipmentImages_EventEquipments_EquipmentId",
                        column: x => x.EquipmentId,
                        principalTable: "EventEquipments",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Venue = table.Column<string>(type: "varchar(500)", maxLength: 500, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ...
                    DepositAmount = table.Column<decimal>(type: "decimal(12,2)", precision: 12, scale: 2, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_EventBookings_EventPackages_PackageId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EventPackageEquipments_EventEquipments_EquipmentId",
                        column: x => x.EquipmentId,
                        principalTable: "EventEquipments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_EventPackageEquipments_EventPackages_PackageId",
                        column: x => x.PackageId,
                        principalTable: "EventPackages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventBookingEquipments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EventBookingEquipments_EventBookings_BookingId",
                        column: x => x.BookingId,
                        principalTable: "EventBookings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EventBookingEquipments_EventEquipments_EquipmentId",
                        column: x => x.EquipmentId,
                        principalTable: "EventEquipments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventBookingEquipments_BookingId",
                table: "EventBookingEquipments",
                column: "BookingId");

            migrationBuilder.CreateIndex(
                name: "IX_EventBookingEquipments_EquipmentId",
                table: "EventBookingEquipments",
                column: "EquipmentId");

            migrationBuilder.CreateIndex(
                name: "IX_EventBookings_EventDate",
                table: "EventBookings",
                column: "EventDate");

            migrationBuilder.CreateIndex(
                name: "IX_EventBookings_PackageId",
                table: "EventBookings",
                column: "PackageId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventEquipmentImages_EquipmentId",
                table: "EventEquipmentImages",
                column: "EquipmentId");

            migrationBuilder.CreateIndex(
                name: "IX_EventEquipments_Category",
                table: "EventEquipments",
                column: "Category");

            migrationBuilder.CreateIndex(
                name: "IX_EventEquipments_IsAvailable",
                table: "EventEquipments",
                column: "IsAvailable");

            migrationBuilder.CreateIndex(
                name: "IX_EventEquipments_ProviderId",
                table: "EventEquipments",
                column: "ProviderId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventPackageEquipments_PackageId",
                table: "EventPackageEquipments",
                column: "PackageId");

            migrationBuilder.CreateIndex(
                name: "IX_EventPackages_IsActive",
                table: "EventPackages",
                column: "IsActive");

            migrationBuilder.CreateIndex(
                name: "IX_EventPackages_PackageType",
                table: "EventPackages",
                column: "PackageType");

            migrationBuilder.CreateIndex(
                name: "IX_EventPackages_ProviderId",
                table: "EventPackages",
                column: "ProviderId");
        }
